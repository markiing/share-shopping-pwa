    ...
    ***************************************************************************** */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(div, "class", div_class_value = "card " + /*cardStyle*/ ctx[0] + " svelte-1au0dmk");
    			add_location(div, file, 20, 0, 511);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*cardStyle*/ 1 && div_class_value !== (div_class_value = "card " + /*cardStyle*/ ctx[0] + " svelte-1au0dmk")) {
    ...
    const file$2 = "src/pages/Shops.page.svelte";
    ...
    // (13:2) <Card cardStyle="fullfiled" on>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(a, file$2, 13, 7, 694);
    			add_location(h3, file$2, 13, 3, 690);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(13:2) <Card cardStyle=\\\"fullfiled\\\" on>",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(main, file$2, 10, 0, 612);
    		},
    		m: function mount(target, anchor) {
    ...
    const file$3 = "src/pages/Shop.page.svelte";
    ...
    // (13:8) <Card cardStyle="outlined">
    function create_default_slot$1(ctx) {
    	let t0_value = /*value*/ ctx[2].name + "";
    	let t0;
    	let t1;
    	let t2_value = /*value*/ ctx[2].price + "";
    	let t2;
    	let t3;
    	let t4_value = /*value*/ ctx[2].quantity + "";
    	let t4;
    	let t5;
    	let t6_value = /*value*/ ctx[2].price * /*value*/ ctx[2].quantity + "";
    	let t6;
    	let t7;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*products*/ 1 && t0_value !== (t0_value = /*value*/ ctx[2].name + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*products*/ 1 && t2_value !== (t2_value = /*value*/ ctx[2].price + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*products*/ 1 && t4_value !== (t4_value = /*value*/ ctx[2].quantity + "")) set_data_dev(t4, t4_value);
    			if (dirty & /*products*/ 1 && t6_value !== (t6_value = /*value*/ ctx[2].price * /*value*/ ctx[2].quantity + "")) set_data_dev(t6, t6_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(13:8) <Card cardStyle=\\\"outlined\\\">",
    		ctx
    	});
    ...
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(12:4) {#each products as {value}}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(div, file$3, 10, 0, 313);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(div, file$4, 12, 2, 269);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
