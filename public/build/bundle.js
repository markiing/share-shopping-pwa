...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    const file$1 = "src/pages/Shops.page.svelte";
    ...
    // (11:2) <Card cardStyle="fullfiled" on>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(a, file$1, 11, 7, 615);
    			add_location(h3, file$1, 11, 3, 611);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(11:2) <Card cardStyle=\\\"fullfiled\\\" on>",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(10:1) {#each shops as {key, value}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(main, file$1, 8, 0, 533);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ get, EVENT_TYPES, link, Card, shops });
    ...
    const file$2 = "src/pages/Shop.page.svelte";

    function get_each_context$1(ctx, list, i) {
    	const child_ctx = ctx.slice();
    	child_ctx[2] = list[i].key;
    	child_ctx[3] = list[i].value;
    	child_ctx[5] = i;
    	return child_ctx;
    }

    // (11:8) <Card cardStyle="outlined">
    function create_default_slot$1(ctx) {
    	let t_value = /*value*/ ctx[3].name + "";
    	let t;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*products*/ 1 && t_value !== (t_value = /*value*/ ctx[3].name + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(11:8) <Card cardStyle=\\\"outlined\\\">",
    		ctx
    	});
    ...
    // (10:4) {#each products as {key, value}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(10:4) {#each products as {key, value}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(div, file$2, 8, 0, 232);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ get, EVENT_TYPES, Card, id, products });
    ...
    class Shop_page extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { id: 1 });
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(nav, file$3, 10, 2, 219);
    			add_location(div, file$3, 12, 2, 236);
    		},
    		m: function mount(target, anchor) {
